        ...
        <Row className="align-items-center">
          ...
          >
            <div className="accessories-single-category">
              ...
              <img
                src={"/assets/images/category/banner-bestseller-1.jpg"}
                className="img-fluid"
                alt=""
              />
          ...
          <Col lg={4} md={8} className="offset-lg-1 offset-md-3 space-mb--r100">
            <div className="accessories-single-category">
              ...
              <img
                src={"/assets/images/category/banner-bestseller-3.jpg"}
                className="img-fluid"
                alt=""
              />
              <div className="accessories-single-category__content">
          ...
          <Col lg={5} md={11} className="offset-lg-1 space-mb--r100">
            <div className="accessories-single-category">
              ...
              <img
                src={"/assets/images/category/banner-bestseller-4.jpg"}
                className="img-fluid"
                alt=""
              />
              <div className="accessories-single-category__content">
          ...
          <Col lg={9} md={10} className="space-mb--r100">
            <div className="accessories-single-category">
              ...
              <img
                src={"/assets/images/category/banner-bestseller-5.jpg"}
                className="img-fluid"
                alt=""
              />
              <div className="accessories-single-category__content">
          ...
          <Col lg={4} md={8} className="offset-lg-1 offset-md-2 space-mb--r100">
            <div className="accessories-single-category">
              ...
              <img
                src={"/assets/images/category/banner-bestseller-6.jpg"}
                className="img-fluid"
                alt=""
              />
              <div className="accessories-single-category__content">
          ...
          <Col lg={4} md={8} className="offset-lg-2 offset-md-1 space-mb--r100">
            <div className="accessories-single-category">
              ...
              <img
                src={"/assets/images/category/banner-bestseller-7.jpg"}
                className="img-fluid"
                alt=""
              />
              <div className="accessories-single-category__content">
          ...
          <Col lg={9} md={8} className="offset-lg-3 offset-md-3 space-mb--r100">
            <div className="accessories-single-category">
              ...
              <img
                src={"/assets/images/category/banner-bestseller-8.jpg"}
                className="img-fluid"
                alt=""
              />
              <div className="accessories-single-category__content">
          ...
          >
            <div className="accessories-single-category">
              ...
              <img
                src={"/assets/images/category/banner-bestseller-9.jpg"}
                className="img-fluid"
                alt=""
              />
              <div className="accessories-single-category__content">
          ...
          <Col lg={4} md={8} className="offset-lg-1 offset-md-2 space-mb--r100">
            <div className="accessories-single-category">
              ...
              <img
                src={"/assets/images/category/banner-bestseller-10.jpg"}
                className="img-fluid"
                alt=""
              />
              <div className="accessories-single-category__content">
