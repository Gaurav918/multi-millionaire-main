...
const LookbookContent = ({ spaceBottomClass }) => {
  return (
    ...
    >
      <Parallax
        bgImage={"/assets/images/backgrounds/bg-parallax-1.jpg"}
        bgImageAlt="image"
        strength={500}
      >
      ...
      <Parallax
        bgImage={"/assets/images/backgrounds/bg-parallax-2.jpg"}
        bgImageAlt="image"
        strength={500}
      >
        <div className="single-lookbook-section">
      ...
      <Parallax
        bgImage={"/assets/images/backgrounds/bg-parallax-3.jpg"}
        bgImageAlt="image"
        strength={500}
      >
        <div className="single-lookbook-section">
      ...
      <Parallax
        bgImage={"/assets/images/backgrounds/bg-parallax-4.jpg"}
        bgImageAlt="image"
        strength={500}
      >
        <div className="single-lookbook-section">
