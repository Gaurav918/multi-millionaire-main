            ...
            <Row>
              ...
              <Col sm={10}>
                <div className="single-category single-category--one space-mb--r130">
                  <div className="single-category__image single-category__image--one">
                    <img
                      src={"/assets/images/category/category-concept-4.jpg"}
                      className="img-fluid"
                      alt=""
                    />
                  </div>
              ...
              <Col sm={8} className="offset-sm-4">
                <div className="single-category single-category--one space-mb--r130">
                  <div className="single-category__image single-category__image--one">
                    <img
                      src={"/assets/images/category/category-concept-3.jpg"}
                      className="img-fluid"
                      alt=""
                    />
                  </div>
              ...
              <Col lg={6} sm={8} className="offset-lg-5">
                <div className="single-category single-category--one">
                  <div className="single-category__image single-category__image--one">
                    <img
                      src={"/assets/images/category/category-concept-1.jpg"}
                      className="img-fluid"
                      alt=""
                    />
                  </div>
            ...
            <Row>
              ...
              <Col lg={6} sm={8} className="offset-lg-2">
                <div className="single-category single-category--one space-mb--r130">
                  <div
                    ...
                    style={{
                      backgroundImage: `url(${"/assets/images/banners/banner-concept.jpg"})`,
                    }}
                  >
                    <p className="text">
                      <span>brand</span>
              ...
              <Col sm={8} className="offset-sm-2">
                <div className="single-category single-category--one">
                  <div className="single-category__image single-category__image--one">
                    <img
                      src={"/assets/images/category/category-concept-2.jpg"}
                      className="img-fluid"
                      alt=""
                    />
                  </div>
