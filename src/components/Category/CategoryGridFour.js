          ...
          <Col md={4}>
            <div className="single-banner single-banner--hoverzoom space-mb--30">
              <Link href="/shop/left-sidebar" as={"/shop/left-sidebar"}>
                <a>
                  <img
                    src={"/assets/images/banners/category-smart-3.jpg"}
                    className="img-fluid"
                    alt=""
                  />
          ...
          <Col md={8}>
            <div className="single-banner single-banner--hoverzoom space-mb--30">
              <Link href="/shop/left-sidebar" as={"/shop/left-sidebar"}>
                <a>
                  <img
                    src={"/assets/images/banners/category-smart-1.jpg"}
                    className="img-fluid"
                    alt=""
                  />
          ...
          <Col md={8}>
            <div className="single-banner single-banner--hoverzoom space-mb--30">
              <Link href="/shop/left-sidebar" as={"/shop/left-sidebar"}>
                <a>
                  <img
                    src={"/assets/images/banners/category-smart-2.jpg"}
                    className="img-fluid"
                    alt=""
                  />
          ...
          <Col md={4}>
            <div className="single-banner single-banner--hoverzoom space-mb--30">
              <Link href="/shop/left-sidebar" as={"/shop/left-sidebar"}>
                <a>
                  <img
                    src={"/assets/images/banners/category-smart-4.jpg"}
                    className="img-fluid"
                    alt=""
                  />
                  <span className="banner-content banner-content--product-type">
