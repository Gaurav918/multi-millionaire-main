          ...
          <Col lg={12}>
            <div className="product-category-text-content text-center space-pt--r100 space-pb--r100">
              <div>
                <div className="image">
                  <img
                    src={"/assets/images/icon/logo-circle.png"}
                    className="img-fluid"
                    alt=""
                  />
                </div>
              ...
              <div className="single-product-category text-center">
                <div className="single-product-category__image">
                  <Link href="/shop/left-sidebar" as={"/shop/left-sidebar"}>
                    <a>
                      <img
                        src={"/assets/images/category/swimsuit-1.png"}
                        className="img-fluid"
                        alt=""
                      />
                    </a>
              ...
              <div className="single-product-category text-center">
                <div className="single-product-category__image">
                  <Link href="/shop/left-sidebar" as={"/shop/left-sidebar"}>
                    <a>
                      <img
                        src={"/assets/images/category/swimsuit-2.png"}
                        className="img-fluid"
                        alt=""
                      />
                    </a>
              ...
              <div className="single-product-category text-center">
                <div className="single-product-category__image">
                  <Link href="/shop/left-sidebar" as={"/shop/left-sidebar"}>
                    <a>
                      <img
                        src={"/assets/images/category/swimsuit-3.png"}
                        className="img-fluid"
                        alt=""
                      />
                    </a>
              ...
              <div className="single-product-category text-center">
                <div className="single-product-category__image">
                  <Link href="/shop/left-sidebar" as={"/shop/left-sidebar"}>
                    <a>
                      <img
                        src={"/assets/images/category/swimsuit-4.png"}
                        className="img-fluid"
                        alt=""
                      />
                    </a>
              ...
              <div className="single-product-category text-center">
                <div className="single-product-category__image">
                  <Link href="/shop/left-sidebar" as={"/shop/left-sidebar"}>
                    <a>
                      <img
                        src={"/assets/images/category/swimsuit-5.png"}
                        className="img-fluid"
                        alt=""
                      />
                    </a>
