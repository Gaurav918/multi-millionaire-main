          ...
          <div className="single-widget-post">
            <div className="image">
              ...
              >
                <a>
                  <img
                    src={"/assets/images/blog/post-thumbnail-100x120.png"}
                    className="img-fluid"
                    alt=""
                  />
                </a>
          ...
          <div className="single-widget-post">
            <div className="image">
              ...
              >
                <a>
                  <img
                    src={"/assets/images/blog/post-thumbnail-6-100x120.png"}
                    className="img-fluid"
                    alt=""
                  />
                </a>
          ...
          <div className="single-widget-post">
            <div className="image">
              ...
              >
                <a>
                  <img
                    src={"/assets/images/blog/post-thumbnail-9-100x120.png"}
                    className="img-fluid"
                    alt=""
                  />
                </a>
      ...
      <div className="single-sidebar-widget space-mb--40">
        <div className="blog-sidebar-banner">
          <Link href="/shop/left-sidebar" as={"/shop/left-sidebar"}>
            <a>
              <img
                src={"/assets/images/banners/blog-sidebar.png"}
                className="img-fluid"
                alt=""
              />
            </a>
